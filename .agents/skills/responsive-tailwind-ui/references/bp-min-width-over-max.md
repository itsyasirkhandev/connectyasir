...
<div
  class="flex gap-8 max-[1024px]:gap-6 max-[768px]:flex-col max-[768px]:gap-4"
>
  <aside class="w-72 shrink-0 max-[1024px]:w-60 max-[768px]:w-full">
    <ul class="space-y-2">
      <li>
        <a
          href="#"
          class="block rounded-md bg-blue-50 px-4 py-2 text-blue-700 max-[768px]:bg-transparent max-[768px]:px-0 max-[768px]:py-1"
          >Overview</a
        >
      </li>
      <li>
        <a
          href="#"
          class="block rounded-md px-4 py-2 text-gray-600 max-[768px]:px-0 max-[768px]:py-1"
          >Analytics</a
        >
      </li>
      <li>
  ...
  <main
    class="flex-1 border-l border-gray-200 pl-8 max-[768px]:border-t max-[768px]:border-l-0 max-[768px]:pt-4 max-[768px]:pl-0"
  >
...
<div class="flex flex-col gap-4 md:flex-row md:gap-8">
  <aside class="w-full md:w-60 md:shrink-0 lg:w-72">
    <ul class="space-y-2">
      <li>
        <a
          href="#"
          class="block py-1 text-blue-700 md:rounded-md md:bg-blue-50 md:px-4 md:py-2"
          >Overview</a
        >
      </li>
      <li>
        <a
          href="#"
          class="block py-1 text-gray-600 md:rounded-md md:px-4 md:py-2"
          >Analytics</a
        >
      </li>
      <li>
  ...
  <main
    class="flex-1 border-t border-gray-200 pt-4 md:border-t-0 md:border-l md:pt-0 md:pl-8"
  >

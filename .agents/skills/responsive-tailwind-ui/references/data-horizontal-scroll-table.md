...
<div class="px-4">
  <table class="w-full border-collapse text-sm">
    <thead>
      <tr
        class="border-b bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase"
      >
  ...
  <table class="w-full min-w-[700px] border-collapse text-sm">
    <thead>
      <tr
        class="border-b bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase"
      >
        <th class="px-3 py-3 whitespace-nowrap">Product</th>
        <th class="px-3 py-3 whitespace-nowrap">Q1 Revenue</th>
        <th class="px-3 py-3 whitespace-nowrap">Q2 Revenue</th>
        <th class="px-3 py-3 whitespace-nowrap">Q3 Revenue</th>
        <th class="px-3 py-3 whitespace-nowrap">Q4 Revenue</th>
        <th class="px-3 py-3 whitespace-nowrap">YoY Growth</th>
        <th class="px-3 py-3 whitespace-nowrap">Margin</th>
      </tr>
    </thead>
    <tbody>
      <tr class="border-b">
        <td class="px-3 py-3 font-medium whitespace-nowrap text-gray-900">
          Enterprise Plan
        </td>
        <td class="px-3 py-3 whitespace-nowrap text-gray-600 tabular-nums">
          $1,245,000
        </td>
        <td class="px-3 py-3 whitespace-nowrap text-gray-600 tabular-nums">
          $1,389,200
        ...
        <td class="px-3 py-3 whitespace-nowrap text-green-600 tabular-nums">
          +34.8%
        </td>
        <td class="px-3 py-3 whitespace-nowrap text-gray-600 tabular-nums">
          72.3%

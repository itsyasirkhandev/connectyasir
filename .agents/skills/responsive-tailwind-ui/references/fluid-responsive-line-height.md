...
<article class="mx-auto max-w-3xl px-4 py-8">
  <h1
    class="text-3xl leading-relaxed font-bold text-gray-900 md:text-5xl md:leading-relaxed"
  >
    Building Responsive Interfaces That Scale Across Every Device
  </h1>
  <p class="mt-6 leading-relaxed text-gray-600">
    When designing for the web, typography choices have an outsized impact on
    how professional and readable your interface feels. Getting line-height
...
<article class="mx-auto max-w-3xl px-4 py-8">
  <h1
    class="text-3xl leading-tight font-bold text-gray-900 md:text-5xl md:leading-[1.15]"
  >
    Building Responsive Interfaces That Scale Across Every Device
  </h1>

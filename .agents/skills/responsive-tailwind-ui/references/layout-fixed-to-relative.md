...
<div class="relative min-h-screen">
  ...
  <button
    class="fixed right-4 bottom-4 z-50 rounded-full bg-blue-600 p-4 text-white shadow-lg"
  >
...
<div class="relative min-h-screen">
  <main class="p-4">
    ...
    <div class="mt-6 md:mt-0">
      <button
        class="w-full rounded-lg bg-blue-600 px-4 py-3 text-center text-sm font-medium text-white shadow md:fixed md:right-4 md:bottom-4 md:z-50 md:w-auto md:rounded-full md:p-4"
      >

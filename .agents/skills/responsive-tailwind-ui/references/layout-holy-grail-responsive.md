...
<div
  class="grid min-h-screen grid-cols-[250px_1fr_200px] grid-rows-[auto_1fr_auto]"
>
...
>
  ...
  <aside
    class="border-b bg-gray-50 p-4 lg:row-start-2 lg:border-r lg:border-b-0"
  >
  ...
  <aside
    class="border-t bg-gray-50 p-4 lg:row-start-2 lg:border-t-0 lg:border-l"
  >
    <h3 class="text-sm font-semibold">Recent Activity</h3>
    <ul class="mt-2 space-y-1 text-sm text-gray-600">
      <li>Deployed v2.4.1</li>

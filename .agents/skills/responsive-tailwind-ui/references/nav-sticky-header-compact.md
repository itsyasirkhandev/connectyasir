    ...
    <div class="mx-4 flex-1">
      <div class="relative">
        <input
          ...
          class="w-full rounded-full border bg-gray-50 py-2.5 pr-4 pl-10 text-sm"
        />
        <svg
...
>
  ...
  <div
    class="flex h-20 items-center justify-between px-4 transition-all duration-300 [.header-compact_&]:h-14"
  >
    <a href="/" class="flex items-center gap-2">
      <img
        src="/logo.svg"
      ...
      />
      <span
        class="text-lg font-bold transition-all duration-300 [.header-compact_&]:text-base"
        >BrandName</span
      >
    </a>
    ...
    <div
      class="mx-4 hidden flex-1 md:block [.header-compact_&]:hidden [.header-compact_&]:md:block"
    >
      <div class="relative">
        <input
          type="search"
          placeholder="Search products, articles..."
          class="w-full rounded-full border bg-gray-50 py-2 pr-4 pl-10 text-sm"
        />
        <svg
          class="absolute top-1/2 left-3 h-5 w-5 -translate-y-1/2 text-gray-400"
          fill="none"

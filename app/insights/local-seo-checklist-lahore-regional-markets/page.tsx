...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { name: 'Local SEO Checklist', path: '/insights/local-seo-checklist-lahore-regional-markets' },
]

const citations = [
  { name: 'Google Business Profile Help Center', url: 'https://support.google.com/business/' },
  { name: 'Moz Local Search Ranking Factors', url: 'https://moz.com/local-search-ranking-factors' },
  { name: 'Google Search Central Local SEO Guide', url: 'https://developers.google.com/search/docs/appearance/locally-relevant-pages' },
]
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <div className="prose prose-invert prose-lg mt-16 max-w-none">
                ...
                <p>
                  Your GBP is the source of truth for Google Maps. In 2026, verification has become stricter—especially in Pakistan.
                </p>
                <div className="bg-muted/30 my-8 rounded-2xl border p-6">
                  <ul className="space-y-4 list-none pl-0">
                    <li className="flex gap-3">
                      ...
                      <div>
                        <strong>Video Verification:</strong> Postcards are rarely used in Pakistan now. Prepare a continuous video take showing your street signage, unlocking your office door, and internal branding.
                      </div>
                    </li>
                    <li className="flex gap-3">
                      <CheckCircle2 className="h-6 w-6 text-green-500 shrink-0" />
                ...
                <h2 className="text-primary mt-12 text-3xl font-semibold">2. The NAP Consistency Rule</h2>
                <p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-8">
                  <div className="border rounded-xl p-4 text-center">
                    ...
                    <span className="text-sm font-semibold">DHA (Phase 1-11)</span>
                  </div>
                  <div className="border rounded-xl p-4 text-center">
                    <MapPin className="h-6 w-6 mx-auto mb-2 text-primary" />
                    <span className="text-sm font-semibold">Gulberg & MM Alam</span>
                  </div>
                  <div className="border rounded-xl p-4 text-center">
                    <MapPin className="h-6 w-6 mx-auto mb-2 text-primary" />
                    <span className="text-sm font-semibold">Johar Town & Model Town</span>
                  </div>
                </div>
                <p>
                  Mentioning local landmarks (like Liberty Market, Badshahi Mosque, or Emporium Mall) in your business description and website copy helps signal your relevance to those specific areas.
                </p>

                <h2 className="text-primary mt-12 text-3xl font-semibold">4. Review Management: Keywords are King</h2>
                <p>
                ...
                <div className="bg-primary/5 mt-16 rounded-3xl border border-primary/20 p-8 md:p-12">
                  <h3 className="text-2xl font-bold">Is your business invisible in Lahore?</h3>
                  <p className="mt-4 text-muted-foreground">
                    If you are not in the top 3 results on Google Maps, you are losing up to 70% of local phone calls and direction requests. I help local businesses audit their GBP and technical SEO to dominate regional markets.
                  </p>
                  <div className="mt-10 flex justify-center">
                    <Link href="/contact">
                      <button className="bg-primary text-primary-foreground flex items-center gap-2 rounded-full px-8 py-3 font-semibold transition-transform hover:scale-105 active:scale-95">
                        Get Your Free Local Audit <ArrowRight className="h-4 w-4" />
                      </button>
                    </Link>
                  </div>
                </div>

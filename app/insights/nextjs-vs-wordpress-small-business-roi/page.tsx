...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { name: 'Next.js vs. WordPress', path: '/insights/nextjs-vs-wordpress-small-business-roi' },
]

const citations = [
  { name: 'Next.js Official Documentation', url: 'https://nextjs.org/' },
  { name: 'Google Core Web Vitals Guide', url: 'https://web.dev/vitals/' },
  { name: 'W3Techs CMS Market Share', url: 'https://w3techs.com/technologies/overview/content_management' },
]
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              <div className="prose prose-invert prose-lg mt-16 max-w-none">
                <p>
                  For over a decade, WordPress has been the default choice for small businesses. It&apos;s accessible, familiar, and powers over 43% of the web. However, as Google&apos;s ranking algorithms shift toward <strong>Core Web Vitals</strong> and AI-driven search (GEO), the technical limitations of traditional WordPress are becoming a growth bottleneck.
                </p>

                <h2 className="text-primary mt-12 text-3xl font-semibold">1. Performance & Conversion: The Sub-Second Advantage</h2>
                <p>
                  Data from <a href="https://web.dev/vitals/" target="_blank" rel="noopener noreferrer">Google&apos;s web.dev</a> consistently shows that every 100ms of latency can reduce conversion rates by up to 7%. 
                </p>
                <div className="bg-muted/30 my-8 rounded-2xl border p-8">
                  <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                    <div>
                      <h4 className="flex items-center gap-2 font-bold"><Zap className="h-5 w-5 text-yellow-500" /> WordPress (Average)</h4>
                    ...
                    <div>
                      <h4 className="flex items-center gap-2 font-bold"><Zap className="h-5 w-5 text-green-500" /> Next.js (Bespoke)</h4>
                      <ul className="mt-4 list-disc pl-5 text-sm">
                        <li>LCP: 0.8s - 1.5s</li>
                ...
                <p>
                  A Next.js site has higher upfront development costs but <strong>near-zero ongoing fees</strong>. Deployed on platforms like Vercel or Cloudflare, hosting is often free for small businesses, and there are no plugin licenses to renew or security patches to worry about.
                </p>

                <h2 className="text-primary mt-12 text-3xl font-semibold">3. Security: A Structurally Smaller Attack Surface</h2>
                <p>
                  97% of WordPress vulnerabilities come from third-party plugins. A monolithic architecture with a public login page (<code>/wp-admin</code>) is a constant target for brute-force attacks.
                </p>
                <p>
                ...
                <div className="bg-primary/5 mt-16 rounded-3xl border border-primary/20 p-8 md:p-12">
                  <h3 className="text-2xl font-bold">Which one is right for you?</h3>
                  <div className="mt-8 grid grid-cols-1 gap-12 md:grid-cols-2">
                    <div className="space-y-4">
                      <h4 className="font-bold text-foreground">Choose WordPress if:</h4>
                    ...
                    <div className="space-y-4">
                      <h4 className="font-bold text-foreground">Choose Next.js if:</h4>
                      <ul className="space-y-2 text-sm text-muted-foreground">
                        <li className="flex items-start gap-2">
                          <span className="text-primary mt-1">✓</span>
                  ...
                  <div className="mt-12 flex justify-center">
                    <Link href="/contact">
                      <button className="bg-primary text-primary-foreground flex items-center gap-2 rounded-full px-8 py-3 font-semibold transition-transform hover:scale-105 active:scale-95">
                        Discuss Your Project ROI <ArrowRight className="h-4 w-4" />
                      </button>
                    </Link>
                  </div>
                </div>

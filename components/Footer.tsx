      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-[2fr_1fr_1fr] md:gap-8">
          ...
          <div className="flex flex-col items-start gap-6">
            <Link 
              href="/" 
              className="text-2xl font-semibold tracking-tighter text-foreground transition-opacity hover:opacity-80"
            >
              {SITE_NAME}
            </Link>
            
            <p className="max-w-xs text-base leading-relaxed text-muted-foreground">
              Designing and building high-trust websites for small businesses — from strategy to launch.
            </p>

            <div className="inline-flex items-center gap-2 rounded-full border border-border/50 bg-muted/30 px-3 py-1 text-sm font-medium text-foreground/80">
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-6 border-t border-border/40 pt-8 md:flex-row">
          ...
          <div className="flex items-center gap-3 text-[10px] font-bold tracking-[0.15em] text-muted-foreground uppercase">

  ...
  return (
    <section className="border-border/50 bg-muted/10 border-y py-12">
      <div className="container mx-auto px-4 sm:px-6">
        <p className="text-muted-foreground mb-10 text-center text-[10px] font-bold tracking-[0.3em] uppercase">
          ...
          {CLIENTS.map((client) => (
            ...
            >
              <div className="relative">
                <span className="font-heading text-foreground/70 group-hover:text-foreground relative z-10 text-2xl font-black tracking-tighter transition-all duration-500 sm:text-3xl">
                  {client.name}
                </span>
              ...
              <span className="text-muted-foreground group-hover:text-primary mt-1 text-[10px] font-bold tracking-[0.2em] uppercase transition-colors duration-500">
                {client.industry}
              </span>
